...
<p>Le tableau de bord Aujourd’hui recommande une prochaine étape à partir du progrès enregistré sur cet appareil : commencer le premier chapitre, faire la séance du jour (cartes dues et questions du chapitre faible), puis passer des examens blancs une fois que vous avez assez étudié. La question du jour est un nouvel item qui reste le même jusqu’à demain.</p>`,
      },
      {
        id: 'question-bank',
...
<p>Les chapitres comptant moins de dix réponses ne bloquent pas le verdict; ils s’affichent comme étant à poursuivre. Un seul bon examen blanc ne suffit pas, car un tirage de 20 questions peut varier.</p>`,
      },
      {
        ...
        html: `<p>Des faits comme le premier ministre fédéral, le gouverneur général, le chef de l’État, le parti au pouvoir, ainsi que le premier ministre, le lieutenant-gouverneur ou commissaire, le chef de l’opposition et le parti au pouvoir de votre province ou territoire peuvent changer. Ces noms sont conservés dans un seul fichier et insérés dans les questions au moment de la compilation. Dernière vérification : ${lastVerified}.</p>
...
<p>The dashboard on Today recommends a next step from the progress stored on this device: start chapter one, run Today’s session (due cards plus weak-chapter questions), then sit mocks once you have studied enough. Question of the day is one new item that stays the same until tomorrow.</p>`,
    },
    {
      id: 'question-bank',
...
<p>Chapters with fewer than ten answers do not block Ready; they show as keep practicing. One good mock is not enough — a 20-question draw is noisy.</p>`,
    },
    {
      ...
      html: `<p>Facts such as the federal prime minister, Governor General, head of state, and party in power — plus your province or territory’s premier, lieutenant governor or commissioner, opposition leader, and governing party — change. Those names live in one file and are filled into questions at build time, last checked ${lastVerified}.</p>
