...
const en: Dict = {
  ...
  'dash.ready':
    'Ready — last three mocks passed, and every chapter has at least 10 answers at 70% or better.',
  'dash.readyNamed':
    '{name}, you are ready — last three mocks passed, and every chapter has at least 10 answers at 70% or better.',
  ...
  'rec.mock.blurb':
    '20 questions, 45 minutes, 15 to pass — the same shape as the real test. Readiness needs three passed mocks and strong chapter scores.',
  ...
  'reason.chapterThin':
    '{chapter} needs more practice ({total} of {need} answers before it counts).',
...
const fr: Dict = {
  ...
  'dash.ready':
    'Prêt — les trois derniers examens blancs sont réussis, et chaque chapitre a au moins 10 réponses à 70 % ou plus.',
  'dash.readyNamed':
    '{name}, vous êtes prêt — les trois derniers examens blancs sont réussis, et chaque chapitre a au moins 10 réponses à 70 % ou plus.',
  ...
  'rec.mock.blurb':
    '20 questions, 45 minutes, 15 pour réussir — le même format que l’examen. La préparation exige trois examens blancs réussis et de bons scores par chapitre.',
  ...
  'reason.chapterThin':
    '{chapter} demande plus de pratique ({total} réponses sur {need} avant de compter).',
